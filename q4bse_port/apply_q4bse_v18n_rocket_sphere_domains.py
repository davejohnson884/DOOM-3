...
This patch is deliberately Rocket-FX scoped by the ACTIVE effect path. Existing
accepted HyperBlaster/Nailgun/Blaster/MG/Shotgun/GL presentation is unchanged.
'''
...
# through to the minimum corner. Scope to the currently playing Rocket effect.
...
# the currently playing Rocket Launcher effect.
...
for required in (
    'domain->type == "sphere"',
    'g_m3Impact.effectPath.find("effects/weapons/rocketlauncher/")',
    'hasGeneratedNormal',
...
print('  - active Rocket effect sphere domains now sample around the true effect origin')
...
print('  - fixes off-center delayed explosion particles and the collapsed firesphere puff')
